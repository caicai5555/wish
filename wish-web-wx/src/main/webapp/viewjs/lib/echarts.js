...
define('echarts/chart/helper/SymbolDraw', ['require', '../../util/graphic', './Symbol'], function (require) {
    ...
    symbolDrawProto.updateData = function (data, isIgnore) {
        ...
        data.diff(oldData).add(function (newIdx) {
            ...
            seriesScope.itemStyle.color = changeColor(data.hostModel.name, data._rawData[newIdx]);
            ...
            function changeColor(name, val){
                ...
                var names = ['甲醛','TVOC', 'PM2.5','空气','温度','湿度'];
                ...
                d1 = val || 0;
                names.forEach(function(v, index){
                    if(v === name){
                        i = index;
                    }
                });
