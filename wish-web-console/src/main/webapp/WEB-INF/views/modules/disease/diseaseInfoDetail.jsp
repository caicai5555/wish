...
<div class="content">
 ...
 <%--       <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="name" name="name" value="${diseaseInfo.name}" maxlength="50" disabled="disabled">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">疾病别名:</label>
            <div class="controls">
                <input type="text" id="alias" name="alias" value="${diseaseInfo.alias}" maxlength="50" disabled="disabled">
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <textarea class="form-control" name="info" id="info" maxlength="250" disabled="disabled">${diseaseInfo.info}</textarea>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">预防:</label>
            <div class="controls">
                <input type="text" id="hint" name="hint" value="${diseaseInfo.hint}" maxlength="50" disabled="disabled">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">就诊科室:</label>
            <div class="controls">
                <textarea class="form-control" name="medicalDepartment" id="medicalDepartment" maxlength="50" disabled="disabled">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <textarea class="form-control" name="infectiousness" id="infectiousness" maxlength="50" disabled="disabled">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="commonSite" name="commonSite" value="${diseaseInfo.commonSite}" maxlength="50" disabled="disabled">
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="inspect" name="inspect" value="${diseaseInfo.inspect}" maxlength="50" disabled="disabled">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">治疗:</label>
            <div class="controls">
                <input type="text" id="cure" name="cure" value="${diseaseInfo.cure}" maxlength="50" disabled="disabled">
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="dietericTreatment" name="dietericTreatment"
                       value="${diseaseInfo.dietericTreatment}" maxlength="50" disabled="disabled">
            </div>
        </div>
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="expertInterpretation" name="expertInterpretation"
                       value="${diseaseInfo.expertInterpretation}" maxlength="50" disabled="disabled">
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                       <c:if test="${diseaseInfo.medicalInsurance==0}"> <input type="text" value="在" disabled/> </c:if>
                       <c:if test="${diseaseInfo.medicalInsurance==1}"><input type="text" value="不在" disabled/></c:if>
            </div>
        </div>
        <div class="control-group">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="multiplePopulation" name="multiplePopulation"
                       value="${diseaseInfo.multiplePopulation}" maxlength="50" disabled>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">并发症:</label>
            <div class="controls">
                <input type="text" id="neopathy" name="neopathy" value="${diseaseInfo.neopathy}" maxlength="50" disabled>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">排序:</label>
            <div class="controls">
                <input type="text" id="sort" name="sort" value="${diseaseInfo.sort}" maxlength="50" disabled>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">是否启用:</label>
            <div class="controls">
                <c:if test="${diseaseInfo.activeFlag==0}"><input type="text" value="启用" disabled/></c:if>
                <c:if test="${diseaseInfo.activeFlag==1}"><input type="text" value="禁用" disabled/></c:if>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label">备注:</label>
            <div class="controls">
                <textarea id="remark" name="remark" value="${diseaseInfo.remark}" maxlength="150" disabled></textarea>
            </div>
        </div>
        <div class="control-group">
