...
<body>
	...
	<form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
		...
		<label for="rememberMe" title="下次不需要再登录" style="color:#fff"><input type="checkbox" id="rememberMe" name="rememberMe" ${rememberMe ? 'checked' : ''}/> 记住我</label>
	...
	<div class="footer">
		Copyright &copy; ${fns:getConfig('copyrightBeginYear')}-${fns:getConfig('copyrightEndYear')} ${fns:getConfig('productName')} - Powered By 云谷技术部 ${fns:getConfig('version')}
	</div>
