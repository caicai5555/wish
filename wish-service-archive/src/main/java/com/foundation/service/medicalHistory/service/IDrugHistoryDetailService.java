...
/**
 * 
* @ClassName: IDrugHistoryDetailService 
* @Description: 用药史明细服务层
* @author chengchen 
* @date 2016年11月22日 下午3:47:58 
*
 */
public interface IDrugHistoryDetailService {
	/**
	 * 
	* @Title: save 
	* @Description: 保存
	...
	* @throws
	 */
	public Page<DrugHistoryDetail> queryPage(Map<String, Object> params,Page<DrugHistoryDetail> pageBounds) throws Exception;
