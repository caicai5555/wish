 ...
 * @version 2013-12-05
 */
@Service("systemServiceSubsystem")
@Transactional(readOnly = true)
public class SystemServiceSubsystemImpl extends BaseServiceImpl implements InitializingBean {
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	 ...
	 * @return
	 */
	public User getUserByLoginName(String loginName, String code) {
		return UserUtils.getByLoginName(loginName, code);
	}
}
