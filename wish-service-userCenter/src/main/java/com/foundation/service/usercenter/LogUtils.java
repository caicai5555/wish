...
import com.foundation.common.utils.*;
...
public class LogUtils {
	...
	private static LogDaoR logDaoR = SpringContextHolder.getBean(LogDaoR.class);
	...
	public static String getMenuNamePath(String requestUri, String permission){
		...
		if (menuMap == null){
			...
			List<Menu> menuList = menuDaoR.findAllList(new Menu());
